          ...
          <div className="grid grid-cols-1 gap-6 text-center sm:grid-cols-3">
            ...
            <div className="rounded-lg bg-white/5 p-6 ring-1 ring-white/10">
              ...
              <a
                ...
                className="block text-sm text-slate-300 transition-colors hover:text-blue-400"
              >
                809-563-2073
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-2 inline-flex cursor-pointer items-center gap-1.5 rounded-full bg-green-500/10 px-2.5 py-1 text-xs font-medium text-green-400 ring-1 ring-inset ring-green-500/20 transition-colors hover:bg-green-500/20"
              >
                <svg
            ...
            <div className="rounded-lg bg-white/5 p-6 ring-1 ring-white/10">
              ...
              <h3 className="mb-2 text-sm font-semibold text-white">
                {dict.contact.info.locations.label}
              </h3>
              <p className="text-sm text-slate-300">
                {dict.contact.info.locations.dr}
              </p>
              <p className="mt-1 text-sm text-slate-300">
                {dict.contact.info.locations.usa}
              </p>
            </div>
            ...
            <div className="rounded-lg bg-white/5 p-6 ring-1 ring-white/10">
              ...
              <a
                href="mailto:hello@mseller.app"
                className="break-all text-sm text-slate-300 transition-colors hover:text-blue-400"
              >
                hello@mseller.app
              </a>
            </div>
